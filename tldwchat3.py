...
def load_audio_video_context(input_video_csv, input_audio_csv):
    detected_text = "Assume you are an answer writing expert bot. Your task is to go through the below provided time-stamped video and audio context of a video. PLease try to correlate between the above provided audio and video context while answering the questions. Please dont say based on the context while answering the questions, try answering the questions as much as possible " + "\n \n"
...
def display_video_page():
    ...
    with col2:
        ...
        # try to generalize your answer relevant to the above provided video and audio context or try to answer th question from your general knowledge, 
        # please dont say: "based on the context", "as per the provided context", "unfortunately, i connot answer the question", "i can not answer the question based on the provided audio/video trasncripts" while answering the questions, 
        # try answering the questions as much as possible \n\n  now, please answer this question if prossible provide video timestamps from where this content/answer is refered from 
        # (the timestamps in the context is in seconds format but to convert that format and provide the video timestamps in hours:minutes:seconds format) always cite your answer to a video timestamp whenever possible even when it is not asked in the question, please answer the question intutively and never say "based on the context", "as per the provided context", "unfortunately, i connot answer the question", "i can not answer the question based on the provided audio/video trasncripts" or other similar terms while answering the questions aslways try to provide some kind of answer \n QUESTION : """
        # but remember whenever you are mentioning a video timestamp in your answer always place them in between ** (i.e. if the video timestamp is 150 seconds place the 150 inyour answer as *150*).
        ...
        and answer the questions that will follow. Please try to correlate between the above provided audio and video context
        while answering the questions. If the question is not relevant to the context provided,
        try to generalize your answer relevant to the above provided video and audio context or try to answer the question from your general knowledge,
        please don't say: "based on the context", "as per the provided context", "unfortunately, i cannot answer the question", "i cannot answer the question based on the provided audio/video transcripts," "also do not provide the timestamps in answers in float/decimal format" while answering the questions,
        try answering the questions as much as possible \n\n  now, please answer this question, if possible provide video timestamps (in seconds integer format and also it's converted format into the hours:minutes:seconds format in brackets, i.e. 150 seconds [00:03:00], 240 seconds[00:04:00], remember to only give video timestamps in integer ( not float/decimal format) format followed by it's converted representation in hours:minutes:seconds format in [] brackets from where this content/answer is referred from
        (the timestamps in the context is in seconds and you provide the answer in seconds format only followed by the seconds format converted into [hours:minutes:seconds] format) if relevant cite your answer to a video timestamp whenever possible even when it is not explicitly asked in the question,  
        please answer the question intuitively, provide detailed/reliable answer to the question asked, and never say "based on the context", "as per the provided context", "unfortunately, i cannot answer the question", "i can not answer the question based on the provided audio/video transcripts" or other similar terms while answering the questions always try to provide some kind of answer. Please remember the timestamps you refer to in the answer should only be in seconds integer format followed by its converted representation into hours:minutes:seconds format (i.e. 150 seconds [00:02:30] etc.) \n QUESTION : """
